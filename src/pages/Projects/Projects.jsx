...
const MORE_PROJECTS = [
  ...
  },
  {
    ...
    captions: [
      { title: 'Configuración del Disparo', desc: 'Paso 1 del asistente para seleccionar la zona específica de la portería hacia donde irá dirigido el tiro.' },
      { title: 'Dirección del Guardameta', desc: 'Paso 2 del asistente para definir el lado al que se lanzará el arquero en la simulación.' },
      { title: 'Contexto del Partido', desc: 'Paso 3 del asistente para ingresar equipo, perfil del cobrador, turno y nivel de presión.' },
      { title: 'Animación de Fallo', desc: 'Animación visual que se muestra cuando el modelo predice un tiro fuera o errado.' },
      { title: 'Animación de Gol', desc: 'Animación visual que se muestra cuando el modelo predice un tiro exitoso.' },
      { title: 'Animación de Atajada', desc: 'Animación visual que se muestra cuando el modelo predice una parada del portero.' },
      { title: 'Resultado y Perfil Conductual', desc: 'Probabilidad de éxito, clúster asignado por K-Means y métricas estimadas.' },
    ],
  },
  {
