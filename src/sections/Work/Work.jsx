...
const PROJECTS = [
  ...
  },
  {
    ...
    fullDescription: 'Page Cut es una extensión de Chrome que permite asignar accesos directos de teclado a elementos específicos de cualquier página web, además de crear accesos directos globales que navegan a URLs que el usuario elija. Incluye un selector visual interactivo para capturar elementos haciendo clic, un escáner que detecta botones, enlaces e inputs con filtros por tipo, detección de duplicados en tiempo real con advertencias de conflicto, modo oscuro/claro con persistencia y selectores CSS inteligentes que generan rutas robustas incluso con menús colapsados.\n\nEs la extensión a la que por mucho más tiempo le ha dedicado, pues, al tener una funcionalidad que puede aplicarse a prácticamente cualquier página web, quería que fuera lo más completa y útil posible, cuidando cada detalle para que la experiencia fuera fluida y natural en cualquier sitio.',
