...
const PROJECTS = [
  {
    ...
    captions: [
      { title: 'Inicio de Sesión', desc: 'Acceso seguro al sistema mediante credenciales tradicionales o Google OAuth.' },
      { title: 'Restablecer contraseña (Código OTP)', desc: 'Verificación del código de seguridad enviado al correo del usuario.' },
      { title: 'Restablecer contraseña (Confirmación)', desc: 'Validación exitosa del código OTP previa al cambio de clave.' },
      { title: 'Reportes', desc: 'Generación de reportes de actividades odontológicas exportables a PDF.' },
      { title: 'Registrar Servicio Odontológico', desc: 'Formulario para parametrizar nuevos tratamientos, tarifas y disponibilidad.' },
      { title: 'Información del Paciente', desc: 'Modal interactivo con el resumen detallado de datos personales y de contacto.' },
      { title: 'Gestión de Pacientes', desc: 'Tabla general para consultar, filtrar, editar o desactivar registros.' },
      { title: 'Registro de Pacientes', desc: 'Formulario por pasos para la creación e ingreso de nuevos usuarios.' },
      { title: 'Mi Información Personal', desc: 'Vista de perfil del usuario autenticado y su rol activo en la plataforma.' },
      { title: 'Crear Historia Clínica (Formulario)', desc: 'Registro de consulta, síntomas y antecedentes bajo metodología SOAP.' },
      { title: 'Crear Historia Clínica (Búsqueda)', desc: 'Selección y verificación de datos del paciente para iniciar la atención médica.' },
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    year: '2026',
    description: 'Extensión de navegador que permite asignar atajos de teclado personalizados a elementos de cualquier página web.',
    fullDescription: 'Page Cut es una extensión de Chrome que permite asignar accesos directos de teclado a elementos específicos de cualquier página web, además de crear accesos directos globales que navegan a URLs que el usuario elija. Incluye un selector visual interactivo para capturar elementos haciendo click, un escáner que detecta botones, enlaces e inputs con filtros por tipo, detección de duplicados en tiempo real con advertencias de conflicto, modo oscuro/claro con persistencia y selectores CSS inteligentes que generan rutas robustas incluso con menús colapsados.\n\nEs la extensión a la que, por mucho, más tiempo le he dedicado, pues, al tener una funcionalidad que puede aplicarse a prácticamente cualquier página web, quería que fuera lo más completa y útil posible, cuidando cada detalle para que la experiencia fuera fluida y natural en cualquier sitio.',
    logo: '/projects/page-cut/page-cut-logo.png',
    accent: '#6dba6b',
    tags: ['Chrome Extension', 'Manifest V3', 'JavaScript', 'HTML', 'CSS'],
    collaborators: [],
    github: 'https://github.com/CamiloAT/page-cut',
    demo: '',
    images: [
      '/projects/page-cut/app-photo-1.webp',
      '/projects/page-cut/app-photo-2.webp',
      '/projects/page-cut/app-photo-3.webp',
      '/projects/page-cut/app-photo-4.webp',
      '/projects/page-cut/app-photo-5.webp',
      '/projects/page-cut/app-photo-6.webp',
      '/projects/page-cut/app-photo-7.webp',
    ],
    captions: [
      { title: 'Atajos de Página', desc: 'Panel principal para gestionar las combinaciones de teclado asignadas a los elementos del sitio web actual.' },
      { title: 'Atajos Globales', desc: 'Vista de administración para comandos de navegación rápida hacia URLs específicas desde cualquier pestaña.' },
      { title: 'Escáner de Elementos', desc: 'Herramienta visual que detecta, lista y filtra botones, enlaces e inputs interactivos de la página.' },
      { title: 'Asignación Local', desc: 'Modal de captura para registrar la combinación de teclas y vincularla a un elemento web específico.' },
      { title: 'Configuración Global', desc: 'Ventana para definir la tecla rápida, la URL de destino y la etiqueta del acceso directo.' },
      { title: 'Página Restringida (Oscuro)', desc: 'Aviso en tema oscuro mostrado en páginas chrome:// debido a restricciones de seguridad del navegador.' },
      { title: 'Página Restringida (Claro)', desc: 'Aviso en tema claro mostrado en páginas chrome:// donde Chrome bloquea la ejecución de extensiones.' },
    ],
  },
]
      ...
      {createPortal(
        <AnimatePresence>
          {hintedProject && (
            ...
            >
              <span className="work__project-hint-text">Click de nuevo para más información</span>
              <svg className="work__project-hint-timer" viewBox="0 0 16 16" width="14" height="14">
