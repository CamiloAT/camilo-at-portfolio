...
const PROJECTS = [
  ...
  },
  {
    ...
    fullDescription: 'Page Cut es una extensión de Chrome que te permite asignar accesos directos de teclado a elementos específicos de cualquier página web, además de crear accesos directos globales que navegan a URLs que elijas. Incluye un selector visual interactivo, escáner de elementos por tipo, detección de duplicados en tiempo real, modo oscuro/claro y selectores CSS inteligentes.',
